  ...
  return (
    ...
    >
      ...
      <Typography variant="caption" color="textSecondary">
        ...
        latency! This dashboard can be slow to update due to API rate limitations, and CryptoInsight will not be liable
      ...
      <Box display="flex" justifyContent="space-between" paddingTop={3} paddingBottom={2}>
        <Button
          ...
          variant="contained"
          href='https://github.com/leonardtng/CryptoInsight'
          target='_blank'
        ...
        <Button
          className={classes.linkButton}
          variant="contained"
          href='https://github.com/leonardtng/CryptoInsight/projects/1'
          target='_blank'
          rel="noopener noreferrer"
          color="secondary"
